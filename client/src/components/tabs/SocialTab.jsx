  ...
  const [challenges, setChallenges] = useState([
    {
      ...
      task: "Perform one small act of kindness daily",
      duration: "5 days",
    ...
    },
    {
      ...
      task: "Reach out to one family member daily",
      duration: "7 days",
    ...
    },
    {
      ...
      task: "Limit social media usage for a day",
      duration: "3 days",
      reward: "Digital Detoxer milestone",
      isStarted: false,
      isCompleted: false,
      timer: 24 * 60 * 60,
      progress: 0,
    ...
    },
    {
      ...
      task: "Go a full day without complaining",
      duration: "3 days",
