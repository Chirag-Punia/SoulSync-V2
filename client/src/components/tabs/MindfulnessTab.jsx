...
function MindfulnessTab() {
  const [challenges, setChallenges] = useState([
    {
      title: "Breathing Exercise Challenge",
      task: "Complete a 3-minute deep breathing exercise twice daily",
      duration: "5 days",
      reward: "Calm Soul badge",
      isStarted: false,
      isCompleted: false,
      timer: 24 * 60 * 60,
      progress: 0,
    ...
    {
      title: "Positive Affirmation Challenge",
      task: "Repeat 5 positive affirmations each morning",
      duration: "7 days",
      reward: "Positive Mindset badge",
      isStarted: false,
      isCompleted: false,
      timer: 24 * 60 * 60,
      progress: 0,
    ...
    },
    {
      ...
      task: "Eat at least one meal mindfully each day",
      duration: "3 days",
    ...
    },
    {
      ...
      task: "Spend 5 minutes visualizing a positive outcome daily",
      duration: "5 days",
      reward: "Visionary badge",
      isStarted: false,
      isCompleted: false,
      timer: 24 * 60 * 60,
      progress: 0,
  ...
  useEffect(() => {
    const savedChallenges = localStorage.getItem("mindfulnessChallenges");
    if (savedChallenges) {
  ...
  useEffect(() => {
    localStorage.setItem("mindfulnessChallenges", JSON.stringify(challenges));
  }, [challenges]);
